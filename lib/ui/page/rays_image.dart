...
class RaysImage extends StatefulWidget {
  @override
  State<RaysImage> createState() => _RaysImageState();
}

class _RaysImageState extends State<RaysImage> {
  ...
  Future<void> predict() async {
    ...
    //           mainAxisSize: MainAxisSize.min,
    //           children: [
    //             Text('Very Mild Demented is a term sometimes used to describe individuals'),
    //             SizedBox(height: 10,),
    //           ],
    //         ),
    //         //Row( Send & Close )
